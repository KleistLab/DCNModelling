...
data = pd.read_excel(filename, sheet_name = 'RAW_20181024_Ctrl')
...
# Convert hours to minutes (consider that first time point is 4.5 hours, and we want to set begin at 0 minutes)
data_multi["Time"] = data_multi["Time (h)"] * 60 - 4.5*60
data_single["Time"] = data_single["Time (h)"] * 60 - 4.5*60
...
# Times are now from 0 to 978-4.5*60= 708 minutes, with a 30 minute frame rate
...
#permutation 1
times_60_perm1 = np.arange(0,708,60)
...
#permutation 2
times_60_perm2 = np.arange(30,708,60)
...
#permutation 1
times_90_perm1 = np.arange(0,708,90)
...
#permuation 2
times_90_perm2 = np.arange(30,708,90)
...
#permuation 3
times_90_perm3 = np.arange(60,708,90)
...
#permutation 1
times_120_perm1 = np.arange(0,708,120)
...
#permuation 2
times_120_perm2 = np.arange(30,708,120)
...
#permuation 3
times_120_perm3 = np.arange(60,708,120)
...
#permuation 4
times_120_perm4 = np.arange(90,708,120)
...
#permutation 1
times_150_perm1 = np.arange(0,708,150)
...
#permuation 2
times_150_perm2 = np.arange(30,708,150)
...
#permuation 3
times_150_perm3 = np.arange(60,708,150)
...
#permuation 4
times_150_perm4 = np.arange(90,708,150)
...
#permuation 5
times_150_perm5 = np.arange(120,708,150)
...
#permutation 1
times_180_perm1 = np.arange(0,708,180)
...
#permuation 2
times_180_perm2 = np.arange(30,708,180)
...
#permuation 3
times_180_perm3 = np.arange(60,708,180)
...
#permuation 4
times_180_perm4 = np.arange(90,708,180)
...
#permuation 5
times_180_perm5 = np.arange(120,708,180)
...
#permuation 6
times_180_perm6 = np.arange(150,708,180)
...
#permutation 1
times_210_perm1 = np.arange(0,708,210)
...
#permuation 2
times_210_perm2 = np.arange(30,708,210)
...
#permuation 3
times_210_perm3 = np.arange(60,708,210)
...
#permuation 4
times_210_perm4 = np.arange(90,708,210)
...
#permuation 5
times_210_perm5 = np.arange(120,708,210)
...
#permuation 6
times_210_perm6 = np.arange(150,708,210)
...
#permuation 7
times_210_perm7 = np.arange(180,708,210)
